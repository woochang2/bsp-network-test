...
class Transaction {
    ...
    async submit(...args) {
        ...
        // var TxEventPayloadPb = new BspTransactionApiPb.TxEventPayload();

        try{
        var pa = await new Promise ((resolve, reject) => {
            aggCli.processProposal(ProposalPb, (err, ProposalResponsePb) => {
                if (err) {
                    ...
                    // console.log("p: ", ProposalResponsePb.toObject().payload);
                    var objectPayload = ProposalResponsePb.toObject().payload
                    
                    // console.log("payload applied value: ",payload);
                    var str = ""
